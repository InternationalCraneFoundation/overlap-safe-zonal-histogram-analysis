...
class HistogramConfig:
    ...
    def default(cls) -> "HistogramConfig":
        ...
        return cls(
            ...
            output_csv=Path(r"C:\Users\SundasRehman\OneDrive - INTERNATIONAL CRANE FOUNDATION\Documents\_Projects\zonalHistogram Script\zonal_histogram_results.csv"),  # ← Change to your output CSV file
        )
